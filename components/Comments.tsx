  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      <div className="flex items-center gap-2 mb-8">
        ...
        <h2 className="text-2xl font-bold text-slate-800">댓글 {comments.length}개</h2>
      </div>
      ...
      {comments.length > 0 ? (
        ...
        <div className="p-12 bg-slate-50 rounded-lg border border-slate-200 border-dashed text-center">
          <MessageCircle className="w-12 h-12 mx-auto mb-4 text-slate-400" />
          <p className="text-slate-600 mb-2">아직 댓글이 없습니다</p>
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            <input
              ...
              className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-400 bg-background text-slate-900 placeholder:text-slate-400"
              disabled
            />
